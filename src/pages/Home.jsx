        ...
        <section className="hero-section container">
            <div className="hero-panel">
                <div className="hero-grid">
                    <motion.div
                        className="hero-left hero-content-glass"
                    ...
                    <div className="hero-right visual-stack">
                        {/* Layer A: Stage Panel - Subtle contrast inside the big panel */}
                        <motion.div
                    ...
                    <div className="partners-grid">
                        {[
                            ...
                            <div key={partner.id} className="partner-logo-container" title={partner.name}>
                                <img
                                    src={`dist/assets/logos/${partner.id}.png`}
